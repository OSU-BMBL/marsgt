...
**Note:The execution of this code approximately takes 2 hours and requires about 90GB of memory.**   &nbsp;&nbsp;&nbsp;&nbsp;[**Example Dataset** ↗](https://github.com/mtduan/marsgt/blob/main/Tutorial/Tutorial_for_example_data.ipynb)   
